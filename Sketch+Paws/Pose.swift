...
class Poses {
    var poseData = [
        ...
        Pose(
            ...
            asana: "Vrksasana",
            icon: "cat_03",
            description: "Trees aren't just for climbing and getting stuck in, they're for yoga too. This can be tricky to balance in but it's a very grounding pose when you get the hang of it!",
